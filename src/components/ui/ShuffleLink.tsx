...
/**
 * ShuffleLink — $50K UPLIFT · D1
 * A link whose characters shuffle through random glyphs on hover, then
 * settle into the real text. The agency-site staple hover effect.
 *
