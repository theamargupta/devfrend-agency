...
/**
 * ParticleField — DA-13
 * A 4000-particle instanced point cloud inside a spherical volume that
 * drifts on mouse parallax and slow-breathes. Shader-free color blend
 * between primary indigo and accent lime, driven by y-position.
 */
