...
/**
 * ShaderBlob — $50K UPLIFT · A1
 * A GLSL-driven, noise-displaced icosahedron. Replaces the "pointy ball of
 * dots" with something that actually looks sculpted. Vertex shader warps
 * the mesh with 3D simplex noise; fragment shader mixes brand colors via
 * view-space fresnel.
 */
...
// Ashima simplex noise (public domain) trimmed for vert displacement.
const SIMPLEX = `
